    ...
    public:
          cudaSubkernelCallHandler(Rewriter &Rewrite) : Rewrite(Rewrite) {}
            ...
            virtual void run(const MatchFinder::MatchResult &Result) {
                ...
                Rewrite.InsertText(kernelCallBody->getLocEnd(),postloopstr, true, true);
                ...
                replaceAll(strTrimmed,"threadIdx.x + blockIdx.x*blockDim.x","logicalChildBlockSeqNum * FL_childBlockSize + threadIdx.x%FL_childBlockSize");
                replaceAll(strTrimmed,"threadIdx.x+ blockIdx.x*blockDim.x","logicalChildBlockSeqNum * FL_childBlockSize + threadIdx.x%FL_childBlockSize");
                replaceAll(strTrimmed,"threadIdx.x +blockIdx.x*blockDim.x","logicalChildBlockSeqNum * FL_childBlockSize + threadIdx.x%FL_childBlockSize");
                replaceAll(strTrimmed,"threadIdx.x+blockIdx.x*blockDim.x","logicalChildBlockSeqNum * FL_childBlockSize + threadIdx.x%FL_childBlockSize");
